...
public class HttpsPoster {
	...
	public static KeyStore getKeyStore(String password, String keyStorePath)
		...
		// 获得密钥库文件流
//		InputStream is = HttpsPoster.class.getClassLoader().getResourceAsStream(keyStorePath);
		InputStream is = HttpsPoster.class.getResourceAsStream(keyStorePath);
		// 加载密钥库
	 ...
	 * @throws Exception
	 */
	public static String post(String url, String post_str) throws Exception {//url是post的目标，post_str是post的数据
		//System.out.println("最终发送的数据："+post_str);
	...
	{
		try {
			HttpsPoster.initHttpsURLConnection("123456","100credit.com.keystore.4jdk1.7","100credit.com.keystore.4jdk1.7");
			HttpsPoster.initHttpsURLConnection("123456","100credit.com.keystore.4jdk1.7","100credit.com.keystore.4jdk1.7");
			HttpsPoster.initHttpsURLConnection("123456","tomcat.keystore","tomcat.keystore");

			URL url = new URL(
"https://sso.100credit.com/serviceValidate?ticket=ST-6-yupHsEgBjcovOpyXVTfI-cas&service=http%3A%2F%2Fidata.100credit.com%2Flogin.action");
			String[] urls = url.toString().split("\\?");
			String result = HttpsPoster.post(urls[0], urls[1]);
			System.out.println(result);

			String result2 = HttpsPoster.post(url.getProtocol() + "://" + url.getAuthority() + url.getPath(), url.getQuery());
