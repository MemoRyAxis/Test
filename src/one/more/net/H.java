...
//		InputStream is = HttpsPoster.class.getClassLoader().getResourceAsStream(keyStorePath);
	...
	{
		try {
			HttpsPoster.initHttpsURLConnection("123456","100credit.com.keystore","100credit.com.keystore");

			URL url = new URL("https://sso.100credit.com/serviceValidate?ticket=ST-2-3Be3dbFmL2J39t2kOhIi-cas&service=http%3A%2F%2Fidata.100credit.com%2Flogin.action");
